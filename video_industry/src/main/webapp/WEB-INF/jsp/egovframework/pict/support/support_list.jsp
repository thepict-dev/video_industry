	                ...
	                <div class="ListWrpper">
	                    ...
	                    <div class="listButton">
	                     ...
	                     <div class="pagination">
		                    <c:if test="${pictVO.pageNumber ne 1}">
		                        <a class="first-page page-button" href="/support/support_list.do?search_text=${param.search_text}&pageNumber=${pictVO.pageNumber - 10 < 1 ? 1 : pictVO.pageNumber - 10}">
		                    ...
		                    <c:forEach var="i" begin="${pictVO.startPage}" end="${pictVO.endPage}">
		                        <c:if test="${i eq pictVO.pageNumber}">
		                            <a class="page-button active" href="/support/support_list.do?search_text=${param.search_text}&pageNumber=${i}">${i}</a>
		                        </c:if>
		                        <c:if test="${i ne pictVO.pageNumber}">
		                            <a class="page-button" href="/support/support_list.do?search_text=${param.search_text}&pageNumber=${i}">${i}</a>
		                        </c:if>
		                    </c:forEach>
