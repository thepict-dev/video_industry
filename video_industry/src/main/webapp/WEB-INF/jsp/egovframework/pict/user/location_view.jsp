		                ...
		                <c:forEach var="resultList" items="${resultList}" varStatus="status">
		                    <div class="poster">
		                        <div class="img-container">
		                            <img src="${resultList.img_thumb}" alt="" srcset="">
		                        </div>
